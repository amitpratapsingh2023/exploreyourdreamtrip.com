...
<script type="application/ld+json">
{
  ...
  "image": [
    ...
    "<?php echo BASE_URL; ?>assets/images/fleet/force-urbania.png"
  ],
  "brand": {
    "@type": "Brand",
...
<section class="relative min-h-[55vh] md:min-h-[60vh] flex items-end bg-obsidian-950 overflow-hidden pt-36 pb-16 md:pb-20">
    ...
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&q=80&w=1200" alt="Premium Car Rental Service"
    ...
    <div class="max-w-[1440px] mx-auto px-4 z-10 w-full space-y-7 text-center">
        ...
        <p class="text-slate-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed font-medium">
            Travel in style and security. Select from our curated fleet of top-tier sedans, luxurious SUVs, and spacious cruiser cabs, driven by polite, verified chauffeurs.
        </p>
    ...
    <div class="glass-nav rounded-[28px] border border-brand/20 p-6 md:p-8 shadow-2xl glow-gold">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-6 sm:gap-y-8 lg:gap-y-0 lg:divide-x lg:divide-white/10">
            ...
            <div class="px-2 sm:px-4 lg:px-6 flex items-center space-x-4">
                ...
                <div>
                    <h4 class="text-white text-xs font-extrabold uppercase tracking-wider font-display">Professional Drivers</h4>
                    <p class="text-slate-400 text-[11px] mt-0.5 font-medium leading-tight">Highly experienced, background-verified, and polite chauffeurs</p>
                </div>
            </div>
            <!-- Item 2 -->
            <div class="px-2 sm:px-4 lg:px-6 flex items-center space-x-4">
                ...
                <div>
                    <h4 class="text-white text-xs font-extrabold uppercase tracking-wider font-display">GPS Safe Fleet</h4>
                    <p class="text-slate-400 text-[11px] mt-0.5 font-medium leading-tight">All vehicles tracked live for occupant safety & peace of mind</p>
                </div>
            </div>
            <!-- Item 3 -->
            <div class="px-2 sm:px-4 lg:px-6 flex items-center space-x-4">
                ...
                <div>
                    <h4 class="text-white text-xs font-extrabold uppercase tracking-wider font-display">Spotless Vehicles</h4>
                    <p class="text-slate-400 text-[11px] mt-0.5 font-medium leading-tight">Deep cleaned and sanitized cabins before every reservation</p>
                </div>
            </div>
            <!-- Item 4 -->
            <div class="px-2 sm:px-4 lg:px-6 flex items-center space-x-4">
                ...
                <div>
                    <h4 class="text-white text-xs font-extrabold uppercase tracking-wider font-display">Transparent Billing</h4>
                    <p class="text-slate-400 text-[11px] mt-0.5 font-medium leading-tight">Fixed quotes with zero hidden booking helper charges</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-slate-50 relative z-10" id="fleet-section">
    <div class="max-w-[1440px] mx-auto px-4">
        ...
        <div class="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <span class="text-brand-accent font-bold text-xs uppercase tracking-widest bg-brand/10 px-3 py-1.5 rounded-full border border-brand/15">Choose Your Ride</span>
            <h2 class="text-3xl md:text-5xl font-extrabold text-obsidian-950 leading-tight">Our Premium Fleet</h2>
            <p class="text-slate-600 text-sm md:text-base">We present our highly maintained cars for rent. From compact family sedans to premium luxury cruisers.</p>
        </div>
                ...
                <div class="group/card bg-white rounded-[32px] overflow-hidden flex flex-col justify-between border border-slate-100 shadow-sm hover:shadow-[0_20px_45px_rgba(15,23,42,0.06)] hover:border-brand/35 hover:-translate-y-2.5 transition-all duration-500">
                    ...
                    <div class="relative overflow-hidden aspect-[4/3] bg-slate-100 z-0">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="text-slate-900 bg-white/95 backdrop-blur-md border border-slate-200/50 px-3.5 py-1.5 rounded-full text-[9px] font-bold uppercase tracking-wider flex items-center space-x-1.5 shadow-sm">
                    ...
                    <div class="p-6 flex-grow flex flex-col justify-between space-y-6">
                        <div class="space-y-4">
                            <h3 class="text-lg font-bold font-display text-obsidian-950 transition-colors duration-300 group-hover/card:text-brand-accent leading-tight line-clamp-1">
                                <?php echo $car['title']; ?>
                            </h3>
                        ...
                        <div class="pt-6 border-t border-slate-100 flex justify-between items-center mt-auto">
                            ...
                            <a href="#inquiry" onclick="selectCarService('car-rental', '<?php echo addslashes($car['title']); ?>')"
    ...
    <div class="max-w-[1440px] mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="group p-8 bg-slate-900/40 backdrop-blur-md rounded-[32px] border border-white/5 hover:border-brand/25 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_15px_35px_rgba(240,210,90,0.05)] space-y-5">
                ...
                <h3 class="text-xl font-bold text-white font-display group-hover:text-brand transition-colors duration-300">Punctual Pickups</h3>
                <p class="text-slate-400 text-sm leading-relaxed">Our drivers arrive at least 15 minutes before the scheduled time to ensure a stress-free departure every single time.</p>
            </div>
            ...
            <div class="group p-8 bg-slate-900/40 backdrop-blur-md rounded-[32px] border border-white/5 hover:border-brand/25 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_15px_35px_rgba(240,210,90,0.05)] space-y-5">
                ...
                <h3 class="text-xl font-bold text-white font-display group-hover:text-brand transition-colors duration-300">Expert Route Navigation</h3>
                <p class="text-slate-400 text-sm leading-relaxed">Highly trained chauffeurs who are well-versed in optimal routes, expressways, and shortcuts to avoid heavy city traffic.</p>
            </div>
            ...
            <div class="group p-8 bg-slate-900/40 backdrop-blur-md rounded-[32px] border border-white/5 hover:border-brand/25 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_15px_35px_rgba(240,210,90,0.05)] space-y-5">
                ...
                <h3 class="text-xl font-bold text-white font-display group-hover:text-brand transition-colors duration-300">Bottled Water & Newspaper</h3>
                <p class="text-slate-400 text-sm leading-relaxed">Complimentary packed mineral water bottles and fresh daily newspaper provided in the cabin for your comfort.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-slate-50 relative overflow-hidden">
    <div class="max-w-[1440px] mx-auto px-4 relative z-10">
        <!-- Section Header -->
        <div class="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <span class="text-brand-accent font-bold text-xs uppercase tracking-widest bg-brand/10 px-3 py-1.5 rounded-full border border-brand/15">Versatile Services</span>
            <h2 class="text-3xl md:text-5xl font-extrabold text-obsidian-950 leading-tight">Rental Use Cases</h2>
            <p class="text-slate-600 text-sm md:text-base">Our premium sedans and SUVs are perfect for a variety of corporate, personal, and leisure trip setups.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group bg-white rounded-[28px] border border-slate-100 p-6 shadow-sm hover:shadow-[0_15px_35px_rgba(15,23,42,0.05)] transition-all duration-300 flex flex-col justify-between">
                <div class="space-y-4">
                    ...
                    <p class="text-slate-500 text-xs leading-relaxed">Reliable, professional chauffeured cars for VIP clients, executive transfers, business meetings, and hotel transits.</p>
                </div>
            ...
            <div class="group bg-white rounded-[28px] border border-slate-100 p-6 shadow-sm hover:shadow-[0_15px_35px_rgba(15,23,42,0.05)] transition-all duration-300 flex flex-col justify-between">
                <div class="space-y-4">
                    ...
                    <p class="text-slate-500 text-xs leading-relaxed">24/7 dedicated airport drop-off and pickup assistance with guaranteed on-time arrivals and flight tracking updates.</p>
                </div>
                <div class="pt-4 border-t border-slate-100 mt-6 text-[10px] text-brand-accent font-bold uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div class="group bg-white rounded-[28px] border border-slate-100 p-6 shadow-sm hover:shadow-[0_15px_35px_rgba(15,23,42,0.05)] transition-all duration-300 flex flex-col justify-between">
                <div class="space-y-4">
                    ...
                    <p class="text-slate-500 text-xs leading-relaxed">Hire a car for multiple days to visit Agra, Jaipur, Shimla, Haridwar, or Rishikesh at your own customized pace.</p>
                </div>
                <div class="pt-4 border-t border-slate-100 mt-6 text-[10px] text-brand-accent font-bold uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div class="group bg-white rounded-[28px] border border-slate-100 p-6 shadow-sm hover:shadow-[0_15px_35px_rgba(15,23,42,0.05)] transition-all duration-300 flex flex-col justify-between">
                <div class="space-y-4">
                    ...
                    <p class="text-slate-500 text-xs leading-relaxed">Premium fleet support to transport wedding guests, families, and attendees in well-synchronized neat vehicles.</p>
                </div>
                <div class="pt-4 border-t border-slate-100 mt-6 text-[10px] text-brand-accent font-bold uppercase tracking-wider flex items-center gap-1.5">
...
<section class="py-20 bg-white relative z-10 border-t border-slate-100">
    <div class="max-w-[1440px] mx-auto px-4">
        <!-- Header -->
        <div class="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <span class="text-brand-accent font-bold text-xs uppercase tracking-widest bg-brand/10 px-3 py-1.5 rounded-full border border-brand/15">Rental Info</span>
            <h2 class="text-3xl md:text-5xl font-extrabold text-obsidian-950 leading-tight">FAQs & Guidelines</h2>
            <p class="text-slate-600 text-sm md:text-base">Transparent guidelines regarding car rental rates, allowances, and booking rules.</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto space-y-5">
            ...
            <div class="faq-item bg-slate-50 rounded-[24px] border border-slate-200/60 overflow-hidden transition-all duration-300">
                <button class="faq-btn w-full text-left p-6 flex items-center justify-between gap-4 font-semibold text-obsidian-950 focus:outline-none hover:bg-slate-100/60 transition-colors">
                    <span class="text-sm md:text-base font-bold font-display">Is fuel cost included in the per-km car rate?</span>
                ...
                <div class="accordion-content">
                    <div class="px-6 pb-6 pt-0 text-slate-600 text-sm leading-relaxed">
                        Yes, the per-kilometer rate covers vehicle running costs, chauffeur allowance, and fuel. Toll taxes, state border permits, and parking fee entries are extra and calculated on actuals.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item bg-slate-50 rounded-[24px] border border-slate-200/60 overflow-hidden transition-all duration-300">
                <button class="faq-btn w-full text-left p-6 flex items-center justify-between gap-4 font-semibold text-obsidian-950 focus:outline-none hover:bg-slate-100/60 transition-colors">
                    <span class="text-sm md:text-base font-bold font-display">What is the minimum billing limit per day for outstation bookings?</span>
                    <i class="faq-icon fa-solid fa-chevron-down text-xs text-slate-400 transition-transform duration-300 flex-shrink-0"></i>
                </button>
                <div class="accordion-content">
                    <div class="px-6 pb-6 pt-0 text-slate-600 text-sm leading-relaxed">
                        For outstation journeys, there is a minimum running average criteria of 250 kilometers per calendar day. In case the vehicle runs less than that, billing is still calculated for 250 km.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item bg-slate-50 rounded-[24px] border border-slate-200/60 overflow-hidden transition-all duration-300">
                <button class="faq-btn w-full text-left p-6 flex items-center justify-between gap-4 font-semibold text-obsidian-950 focus:outline-none hover:bg-slate-100/60 transition-colors">
                    <span class="text-sm md:text-base font-bold font-display">Are there any extra charges for night driving?</span>
                    <i class="faq-icon fa-solid fa-chevron-down text-xs text-slate-400 transition-transform duration-300 flex-shrink-0"></i>
                </button>
                <div class="accordion-content">
                    <div class="px-6 pb-6 pt-0 text-slate-600 text-sm leading-relaxed">
                        Yes, if the vehicle is driven between 10:00 PM and 5:00 AM, a night driver allowance (typically ₹300 - ₹500 depending on the vehicle size) is charged to cover chauffeur overtime.
                    </div>
                </div>
            </div>
        </div>
