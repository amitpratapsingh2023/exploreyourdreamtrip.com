        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 bg-obsidian-950 rounded-[40px] overflow-hidden border border-white/5 shadow-2xl glow-gold/5">
            ...
            <div class="lg:col-span-5 p-8 md:p-12 space-y-8 bg-gradient-dark flex flex-col justify-between">
                <div class="space-y-4">
                    ...
                    <h3 class="text-3xl font-bold font-display text-white">Let's Design Your <span class="text-gradient-gold">Dream Tour</span></h3>
                ...
                <div class="space-y-6">
                    <a href="tel:<?php echo CONTACT_PHONE_RAW; ?>" class="flex items-center space-x-4 group">
                        <div class="w-12 h-12 rounded-2xl bg-white/5 text-brand border border-white/10 group-hover:bg-brand/10 group-hover:text-brand-light group-hover:border-brand/40 flex items-center justify-center text-lg transition-all duration-300">
                    ...
                    <a href="<?php echo WHATSAPP_LINK; ?>" target="_blank" class="flex items-center space-x-4 group">
                        <div class="w-12 h-12 rounded-2xl bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 group-hover:bg-emerald-500 group-hover:text-white group-hover:border-transparent flex items-center justify-center text-xl transition-all duration-300">
                            <i class="fa-brands fa-whatsapp"></i>
                        </div>
                        <div>
                            <p class="text-xs text-slate-400">Instant Chat Assistance</p>
                            <p class="text-emerald-400 font-bold group-hover:text-emerald-300 transition-colors">Click to Chat on WhatsApp</p>
                        </div>
                    </a>
                </div>
            ...
            <div class="lg:col-span-7 p-8 md:p-12 border-t lg:border-t-0 lg:border-l border-white/5">
                <form action="javascript:void(0);" onsubmit="alert('Thank you for your inquiry! Our travel representative will contact you shortly.');" class="space-y-6">
                    ...
                    <button type="submit" class="w-full py-4 bg-gradient-gold text-obsidian-950 font-bold rounded-xl shadow-lg hover:shadow-brand/25 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 pulse-gold-btn uppercase tracking-wider text-xs">
